...
Imagina que lhe foi pedido para fazer uma pequena aplicação que demonstre sobre viagens, falando um pouco do lugar, cultura, comidas típicas e pontos turísticos.
...
- Pelo menos três rotas que mostrem três países diferentes.
- Cada país deve ter sub-rotas que mostrem pelo menos 3 cidades diferentes
- Cada cidade deve ter sub-rotas para detalhes gerais, cultura, comidas típicas e pontos turísticos.
...
- ReactJs
- fazer deploy
- Deve se usar o react-router-dom V6 e componentes funcionais
- Não se deve usar high order componentes (HOC).
- Deve se usar nested routes.
...
- Usar typeScript
- Usar o Outlet do react router dom
- usar o Suspense do react router dom
